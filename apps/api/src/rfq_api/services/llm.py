    ...
    def generate_rubric(
        ...
        *,
        ...
        instructions = (
            ...
            "Do not assume every buyer-entered mandatory condition must become a MAC. "
            "You must still evaluate every buyer-entered mandatory condition explicitly and reflect each one somewhere in the rubric. "
            "If a buyer-entered mandatory condition is truly disqualifying, map it to MAC. "
            "If it is about delivery strength, governance quality, commercial completeness, staffing depth, timeline confidence, or another dimension that is better judged on a spectrum, "
            "map it to a scored technical or commercial criterion instead of MAC. "
            "Reserve MAC only for the most critical non-negotiable legal, regulatory, safety, child-protection, licensing, or explicit eligibility requirements "
            "where immediate rejection would be justified. "
            "For a services RFQ, items such as named engagement lead, governance approach, launch-plan credibility, staffing depth, experience strength, "
            "or general response completeness should normally become scored technical or commercial criteria instead of MAC unless the RFQ explicitly says they are disqualifying. "
            "If you are unsure whether a criterion should be MAC or scored, prefer scored. "
            "In a typical services RFQ, expect only a small number of MAC criteria, often around one to three. "
